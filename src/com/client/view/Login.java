...
public class Login extends JFrame implements ActionListener {
    ...
    private JLabel jlb_north;//上面背景图片标签
    ...
    private JButton btn_login;//下面登录按钮
    ...
    public Login() {
        ...
        //处理北部背景图片标签
        jlb_north = new JLabel(new ImageIcon("image/login/login.png"));
        //图片的大小还没调整
        ...
        btn_exit = new JButton(new ImageIcon("image/login/exit.jpg"));
        ...
        //中左头像
        jlb_photo = new JLabel(new ImageIcon("image/login/touxiang.jpg"));
        ...
        c.add(autoLog);
        //处理登录按钮
        btn_login = new JButton(new ImageIcon("image/login/loginbutton.jpg"));
